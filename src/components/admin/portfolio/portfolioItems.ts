...
export const defaultPortfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: 'websites',
    image: 'https://images.unsplash.com/photo-1593055454503-531d165c2ed8?auto=format&fit=crop&w=600&h=400',
    description: 'Invoice and quotation generator for agriculture business. Streamlines the process of creating professional invoices and quotations for clients.',
  ...
  },
  {
    ...
    title: 'Inning Live',
    category: 'websites',
    image: 'https://images.unsplash.com/photo-1531415074968-036ba1b575da?auto=format&fit=crop&w=600&h=400',
    description: 'Cricket tournament management platform allowing users to organize and manage cricket tournaments with live scoring and statistics.',
  ...
  },
  {
    ...
    category: 'websites',
    image: 'https://images.unsplash.com/photo-1551867633-194f125bcc72?auto=format&fit=crop&w=600&h=400',
    description: 'Secure the best talent for your security needs. SOSS Placement provides top-notch security personnel with military and law enforcement backgrounds to protect your assets with precision and professionalism.',
