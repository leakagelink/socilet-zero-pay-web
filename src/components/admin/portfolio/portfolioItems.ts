...
export const defaultPortfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    description: 'Your trusted partner for professional services, startup funding, and business growth. From certifications to compliance - we\'ve got you covered.',
    url: 'https://connectwithca.in/',
    isReactProject: true
  },
  {
    id: 2,
    title: 'DocuCreator Pro',
    category: 'ai',
  ...
  },
  {
    ...
    description: 'Advanced AI content generation platform tailored for Indian market.',
  ...
  {
    id: 8,
    title: 'SOSS Placements',
    category: 'websites',
    image: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=800&h=600',
    description: 'Professional placement and recruitment services platform.',
    url: 'https://sossplacementsprivatelimited.com',
    isWordPressProject: true
  },
  {
    id: 9,
    ...
    category: 'websites',
    image: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?auto=format&fit=crop&w=800&h=600',
    description: 'Comprehensive agricultural services and product distribution.',
    url: 'https://lakshmikrupaagriculture.com',
    isWordPressProject: true
  },
  {
    id: 10,
    title: 'Asset Security Tech',
    category: 'websites',
    image: 'https://images.unsplash.com/photo-1555949963-aa79dcee981c?auto=format&fit=crop&w=800&h=600',
    description: 'Advanced security solutions and asset protection services.',
  ...
  },
  {
    ...
    category: 'websites',
    image: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?auto=format&fit=crop&w=800&h=600',
    description: 'Health and nutrition guidance platform with personalized plans.',
    url: 'https://alrightnutrition.com',
    isWordPressProject: true
  },
  {
    id: 12,
    title: 'Pinnacle Sync Tech',
    category: 'websites',
    image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=800&h=600',
    description: 'Technology synchronization and integration solutions.',
  ...
  },
  {
    ...
    title: 'Icarus HR',
    category: 'websites',
    image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=800&h=600',
    description: 'Human resource management and employee engagement platform.',
