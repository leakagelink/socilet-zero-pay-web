...
const AffordableWebsiteSmallBusiness: React.FC<BlogContentProps> = ({ post, onBack }) => {
  ...
  const articleSchema = {
    ...
    "author": {
      ...
      "description": "7+ years experience helping small businesses build affordable websites"
    },
    "publisher": {
      "@type": "Organization",
      "name": "Socilet",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="affordable website development small business, cheap website design, budget website development, small business website cost" />
