        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <p>
                We work on a zero advance payment and work-first-pay-later business model to protect people from scams. In today's time, there are many developers who take advance payments, then stop responding or deliver incomplete work, or use templates that don't match the client's requirements.
              </p>
              
              <p>
                While users are willing to pay good money and substantial advance payments, many developers or freelancers don't honestly complete their work properly. And when users have spent their hard-earned money, they become very frustrated but no one can help them.
              </p>
              
              <p>
                Socilet wants to completely eliminate these scams and frauds happening in the market. That's why Socilet works on zero advance payment, doesn't charge any hidden or extra fees, and provides uptime support and quality work.
              </p>
              
              <p>
                We say that if you don't like our work, don't pay us even 1 rupee. Socilet believes in quality work, and we don't want your hard-earned money to be wasted, so don't work with scammers, work with Socilet.
              </p>
